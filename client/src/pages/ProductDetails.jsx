...
const ProductDetails = () => {
    ...
    const {id} = useParams()
    //useParams() is a React Router hook that lets you access URL parameters from the route.

    const [relatedProducts, setRelatedProducts] = useState([]);
    const [thumbnail, setThumbnail] = useState(null);

    const product = products.find((item)=> item._id === id);
    //This line searches through the products array and finds the first item whose _id matches the given id.
    ...
    return product && (
        <div className="mt-12">
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                //This scrolls the page to the very top-left corner — often used after a navigation to make sure the user starts at the top of the new page (instead of where they left off on the previous one).
